...
const changeMarker = () => {
  ...
  message("It is "+currentMarker+"'s turn.");
}

function message(msg) {
    document.getElementById("actionStatus").innerHTML=msg;
}

function score(){
  document.getElementById("score").innerHTML="X: " + wins["X"] + " wins, O: " + wins["O"] + " wins";
